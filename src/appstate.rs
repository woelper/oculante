...
pub struct OculanteState {
    ...
    pub current_modifications_image: Option<RgbaImage>,
    pub current_modifications_image_reset: bool,
...
impl<'b> Default for OculanteState {
    fn default() -> OculanteState {
        ...
        OculanteState {
            ...
            current_modifications_image: Default::default(),
            current_modifications_image_reset: false,
